-- ============================================================================
-- CORRECTED: Database Fix (Handles Check Constraints)
-- ============================================================================
...
SELECT '📦 Coupons Created:' as info, code, discount_type, is_active 
FROM public.coupons 
ORDER BY code;

SELECT '📊 Product Categories:' as info, category, COUNT(*) as count
FROM public.products
GROUP BY category;

-- ===========================================================================
-- DONE! Refresh your website and test checkout
-- ===========================================================================
